...
* Refine the gradle properties file patcher to not adding a trailing new line when patching the file.
* A potential vulnerability scanner warning that the file provider can read files from a wider scope than actually needed.
